...
/***/ function(module, exports, __webpack_require__) {
	...
	var _temp = __webpack_require__(3);
	
	var _temp2 = _interopRequireDefault(_temp);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	(0, _jquery2.default)('#container1').html('sssss');
	(0, _jquery2.default)('#container2').html('Good point: ' + new _box2.default(1, 23).toString());
	
	(0, _temp2.default)({ test: 'good3' }, function (err, out) {
	    (0, _jquery2.default)('#container3').html(out);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dust = __webpack_require__(4); (function(dust){dust.register("template\/temp1",body_0);function body_0(chk,ctx){return chk.w("<div>").f(ctx.get(["test"], false),ctx,"h").w("</div>");}body_0.__dustBody=!0;return body_0}(dust));var fn = function( context, callback ) { dust.render( 'template/temp1', context, callback ); }; fn.templateName = "template/temp1"; module.exports = fn;
