...
/***/ function(module, exports, __webpack_require__) {
	...
	var _box3 = __webpack_require__(5);
	...
	(0, _jquery2.default)('#container').on('click', '.card-content', function (e) {
	    (0, _jquery2.default)(e.target).toggleClass('card-omission');
	    (0, _jquery2.default)(e.target).toggleClass('card-scroll');
	    (0, _jquery2.default)(e.target).animate({ scrollTop: 0 }, "fast");
	});
	...
	function deletePositions(father, direction) {
	    ...
	    for (var i = 1; i <= 10; i++) {
	        ...
	        if ((0, _jquery2.default)(_id).length) {
	...
	function deleteBox(id, top, left) {
	    var _target = (0, _jquery2.default)(id);
	...
	var addBox = function addBox(_d, top, left) {
	    (0, _box4.default)(_d, function (err, out) {
	        var $out = (0, _jquery2.default)(out);
	        $out.css('z-index', 1);
	        (0, _jquery2.default)('#container').append(out);
	        (0, _jquery2.default)('.' + _d.position).animate({ top: top, left: left }, 1000);
	    });
	};
	//function addBox(_d, top, left) {
...
/***/ function(module, exports) {
	...
	var Box = function () {
	    ...
	    _createClass(Box, [{
	        ...
	        key: "getLeadToBoxed",
	        value: function getLeadToBoxed() {}
	    }, {
	        key: "getRelateToBoxed",
	        value: function getRelateToBoxed() {}
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(process) {(function (root, factory) {
	  if ("function" === 'function' && __webpack_require__(8) && __webpack_require__(8).dust === true) {
